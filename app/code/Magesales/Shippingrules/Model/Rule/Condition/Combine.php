<?php
namespace Magesales\Shippingrules\Model\Rule\Condition;
...
class Combine extends \Magento\Rule\Model\Condition\Combine
{
    ...
    )
    {
        ...
        $this->setType('Magesales\Shippingrules\Model\Rule\Condition\Combine');
    }
    ...
    public function getNewChildSelectOptions()
    {
        ...
        foreach ($addressAttributes as $code=>$label) {
            $attributes[] = array('value'=>'Magesales\Shippingrules\Model\Rule\Condition\Address|'.$code, 'label'=>$label);
        }

        $conditions = parent::getNewChildSelectOptions();
        $conditions = array_merge_recursive($conditions, array(
            array('value' => 'Magesales\Shippingrules\Model\Rule\Condition\Product\Subselect', 'label'=>__('Products subselection')),
