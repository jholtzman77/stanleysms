...
abstract class AbstractConfig extends ConfigUtils
{
     ...
     *   1. Add pr_extensions.xml with attribute "is_enabled_path" (recommended)
     *   2. Rewrite method and return true (recommended for free modules)
     *   3. Use \Plumrocket\Base\Helper\AbstractConfig::isModuleEnabledInConfig method (not recommended)
     *   4. Rewrite method and write own logic (not recommended)
     *
     * @param null $store
     * @param null $scope
     * @return bool
